...
public class BasicBlockingQueue<E> extends AbstractBasicQueue<E, LinkedBlockingQueue<Ref<E>>>
     ...
     * @param cacheAccessor an elements space allocator.
     */
    ...
    /**
     * Inserts a specified element at the tail of this queue, waiting if necessary for queue or cacheAccessor
     ...
     * for queue or cacheAccessor space to become available.
     *
     * @param e an element to insert.
